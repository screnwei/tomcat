...
public final class StandardServer extends LifecycleMBeanBase implements Server {
    ...
    protected void initInternal() throws LifecycleException {
        ...
        // 虽然StringCache是全局的，但是如果在同一个jvm中存在多个Server，那么则会往jmx中
        // 注册多个不同名字的StringCache，这种情况很有可能会在内嵌的tomcat中发生
        ...
        // 初始化GloalNamingResource资源，见server.xml中定义的GlobalNamingResources
